                    ...
                    <form class="box-search" @submit.prevent="">
                        ...
                        <div class="form-inputs d-flex justify-content-start flex-row flex-wrap">
                            <div class="input-content">
                                ...
                                <div class="input-section">
                                    <div class="input-icon">
                                        <img src="https://gustavojoia.github.io/iprepository/images/icon-searchlight.png" alt="Projeto Interdisciplinar">
                                    </div>
                            ...
                            <div class="input-content">
                                ...
                                <div class="select-section">
                                    <div class="input-icon">
                                        <img src="https://gustavojoia.github.io/iprepository/images/icon-bottom.png" alt="Projeto Interdisciplinar">
                                    </div>
                        ...
                        <div class="form-inputs align-items-end flex-wrap">
                            <div class="input-content">
                                ...
                                <div class="input-section">
                                    <div class="input-icon">
                                        <img src="https://gustavojoia.github.io/iprepository/images/calendar.png" alt="Projeto Interdisciplinar">
                                    </div>
