            ...
            <section class="dinamic-content">
                ...
                <div class="section-files d-flex flex-column justify-content-start gap-2">
                    <div class="title d-flex justify-content-start flex-row align-items-center gap-3">
                        <img class="icon" src="https://gustavojoia.github.io/iprepository/images/icon-file.png" alt="Projeto Interdisciplinar">
                        <h2>Anexos</h2>
                    </div>
                    ...
                    <div v-for="(file, index) in files" class="files-content d-flex justify-content-between flex-row">
                        ...
                        <div class="left-data d-flex justify-content-start align-items-center flex-row gap-3">
                            <img v-if="isPdf(file.File_Type)" class="icon" src="https://gustavojoia.github.io/iprepository/images/icon-pdf.png" alt="Projeto Interdisciplinar">
                            <img v-if="isImg(file.File_Type)" class="icon" src="https://gustavojoia.github.io/iprepository/images/icon-upload.png" alt="Projeto Interdisciplinar">
                            <img v-if="isLink(file.File_Type)" class="icon" src="https://gustavojoia.github.io/iprepository/images/icon-link.png" alt="Projeto Interdisciplinar">
                            <img v-if="isElse(file.File_Type)" class="icon" src="https://gustavojoia.github.io/iprepository/images/icon-file.png" alt="Projeto Interdisciplinar">
                        ...
                        <div class="right-data d-flex justify-content-start align-items-center flex-row gap-3">
                            <a v-if="isLink(file.File_Type)" :href="file.URL" target="_blank">
                                <img class="icon" src="https://gustavojoia.github.io/iprepository/images/icon-upload.png" alt="Projeto Interdisciplinar">
                            </a>
                ...
                <div class="section-info">
                    <div class="label-content">
                        ...
                        <div class="d-flex justify-content-start flex-row gap-2">
                            <img class="icon" src="https://gustavojoia.github.io/iprepository/images/external-link.png" alt="Projeto Interdisciplinar">
