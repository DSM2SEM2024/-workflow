                        ...
                        <div class="form-gap d-flex d-row flex-row">
                            ...
                            <div class="form-entries d-flex justify-content-start d-column flex-column">
                                ...
                                <div class="files" v-for="(file, index) in attach.files" :key="index">
                                    <img v-if="isPdf(file)" src="https://gustavojoia.github.io/iprepository/images/file-pdf.png" alt="Expandir">
                                    <img v-if="isImg(file)" src="https://gustavojoia.github.io/iprepository/images/icon-upload.png" alt="Expandir">
                                    <img v-if="isElse(file)" src="https://gustavojoia.github.io/iprepository/images/icon-file.png" alt="Expandir">
                                    <p>{{file.name}}</p>
